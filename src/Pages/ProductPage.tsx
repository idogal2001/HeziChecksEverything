...
const ProductPage = () => {
    ...
    const [priceTotal, setPriceTotal] = useState<number>(productInfo[0].price);
            ...
            <div className={styles.webContainerProduct}>
                <div className={styles.productInfo}>
                    ...
                    <span className={styles.productAmount}>
                        <input className={styles.itemInput} type="number" name='Amount of Item' defaultValue="1" onChange={changeAmount}></input>
                    </span>
